...
describe("MoveHandlerService", () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [
        ...
        {
          provide: FirstPersonMoveHandler,
          useClass: FirstPersonMoveHandlerMock
        },
  ...
  describe("rewardMajorityAndMinorityStockholders()", () => {
    ...
    beforeEach(() => {
      ...
      spyOn(hotelChainService, "getMergeMajorityBonus").and.returnValue(
        majorityBonus
      );
      spyOn(hotelChainService, "getMergeMinorityBonus").and.returnValue(
        minorityBonus
      );
    });
    ...
    it("should give majority bonuses to majority and minority stockholders", () => {
      ...
      spyOn(playerService, "getMajorityStockholders").and.returnValue(
        majorityStockholders
      );
      spyOn(playerService, "getMinorityStockholders").and.returnValue(
        minorityStockholders
      );
